# Multi-Stack Project — Codex Instructions (2026 Edition)
...
**Note:** No agent has `Task` tool — subagents cannot spawn other subagents. Main Codex orchestrates.

---

## Session Tracking — `.Codex/state.md`

Each workflow session must be documented in `.Codex/state.md` for audit trail, progress tracking, and regression prevention.
...
Defined in `.Codex/skills/`. See `.Codex/skills/README.md` for source attribution.

| Skill             | Used by        | Source                                           |
|-------------------|----------------|--------------------------------------------------|
| `plan`            | web-planner    | community (alirezarezvani/Codex-skills)         |
...
| `code-review`     | web-reviewer   | anthropics/Codex (official)                |
| `security-review` | web-reviewer   | anthropics/Codex-security-review           |

### Desktop Stack Skills

| Skill             | Used by         | Source                                           |
|-------------------|-----------------|--------------------------------------------------|
| `plan`            | desktop-planner | community (alirezarezvani/Codex-skills)         |
| `database-design` | desktop-builder | community (Python SQLAlchemy patterns)           |
| `code-review`     | desktop-reviewer| anthropics/Codex (official)                |
| `security-review` | desktop-reviewer| anthropics/Codex-security-review           |

### Mobile Stack Skills (2026)

| Skill                   | Used by          | Source                                           |
|-------------------------|------------------|--------------------------------------------------|
| `plan`                  | mobile-planner   | community (alirezarezvani/Codex-skills)         |
...
| `code-review`           | mobile-reviewer  | anthropics/Codex (official)                |
| `security-review`       | mobile-reviewer  | anthropics/Codex-security-review           |
